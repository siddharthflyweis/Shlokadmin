    ...
    <div>
      ...
      <div className="mt-5">
        <table className="w-full">
          <thead>
            <tr>
              <th className="w-[200px] text-left text-[#0F2C64]">Meeting ID</th>
              <th className="text-left text-[#0F2C64] w-[200px]">Date</th>
              <th className="w-[150px] text-left text-[#0F2C64]">Attendant</th>
              ...
              <th className="w-[100px] text-center text-[#0F2C64]">Status</th>
            </tr>
          </thead>
          <tbody>
            <tr>
