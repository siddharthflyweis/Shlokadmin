  ...
  return (
    <div>
      <div className="flex flex-wrap gap-10 justify-center">
        <div className="w-[350px] h-[200px] shadow-lg">
          ...
          <div className="flex justify-between ml-2 mr-2 mt-14">
            <div>
              <span className="bg-[#E6EEFF] rounded-2xl p-1 mr-1">14 </span>old
              lawyers
            </div>
            <div>
              <span className="bg-[#E6EEFF] rounded-2xl p-1 mr-1">14 </span> New
              lawyers
            </div>
          </div>
        </div>
        ...
        <div className="w-[350px] h-[200px] shadow-lg">
          <div className="text-2xl font-medium mt-5 ml-5">Total Complaints</div>
          <hr />
          <span className="flex justify-center text-4xl font-semibold mt-2">
            24
          </span>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr>
                ...
                <td className="w-[50px] text-left">Loreum Ipsum</td>
